...
录制演示前可运行 python scripts/reset_demo.py 复原 demo 中的故障。
...
特色功能：
1. 支持 list_files、search_text、read_file、write_file、append_file、replace_text、run_command 七个本地工具，覆盖搜索、读文件、改文件和运行测试的基本编程流程。
